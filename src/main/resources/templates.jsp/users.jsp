...
<title>VideoStore. Alta/Modificación de usuarios</title>
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<div class="form-group">
											<label for="inputRepeatPassword2"> Repetir contraseña
						...
						<div class="modal fade" id="modal-container-delete-user"
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										<div class="form-group">
											<label> ¿Estás seguro de que quieres eliminar este
												usuario? </label>
										</div>
									</div>
									<div class="modal-footer">
				...
				function() {
					...
					$('#inputEmail').on('input', function() {
						...
						if(is_email){
							...
							error.removeClass("hidden");
							error.text("* Dirección de email incorrecta");
						}
					});
					...
					$('#usersTable').dataTable( {
						...
						"columnDefs": [
						    ...
						    //{ "name": "Fecha de creación", "targets": 4 },
